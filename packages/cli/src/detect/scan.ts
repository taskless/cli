 ...
 * language; the scope difference is deliberate and documented there. Note the
 * probe adds its own Node entry, since the JavaScript/TypeScript resolution
 * mentioned above happens outside this constant.
 */
